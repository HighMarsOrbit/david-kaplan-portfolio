...
function page() {
  return (
    <div className="flex flex-col items-center justify-center h-screen text-center">
      <h1 className="text-6xl font-bold text-gray-800 dark:text-gray-100">404! That's an error.</h1>
      <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">These are not the droids you are looking for.</p>
